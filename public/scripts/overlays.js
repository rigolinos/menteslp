...
(function() {
    ...
    var _cachedScrollY = 0;

    function openOverlay(id) {
        if (typeof window.pauseScrollytelling === 'function') window.pauseScrollytelling();
    ...
    function closeOverlay() {
        ...
        var onCompleteClose = function() {
            ...
            window.scrollTo(0, _cachedScrollY); // Restaura exatamente onde parou
            if (typeof window.resumeScrollytelling === 'function') window.resumeScrollytelling();
            if (window.ScrollTrigger) {
